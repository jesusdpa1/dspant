...
try:
    ...
    from dspant.processor.basic.energy import _classic_tkeo, _modified_tkeo

from dspant.engine.streams.pipeline import StreamProcessingPipeline
from dspant.processor.basic.rectification import RectificationProcessor
from dspant.processor.filters import FilterProcessor, create_lowpass_filter
...
def create_tkeo_envelope_rs(
    ...
    if _HAS_RUST and use_rust:
        ...
        from dspant.processor.basic.energy import TKEOProcessor
